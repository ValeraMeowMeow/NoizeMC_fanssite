...
<html>
	...
	<head>
		...
		<!-- Название страницы -->
		<title>Фан-сайт | Noize MC | Регистрация</title>
        ...
        <div class="search">
            ...
            <form action="register.php" method="post" name="form_register">
                <table>
                    ...
                    <tr>
                        <td>
                            <input type="text" name="s_name" placeholder="Имя" required="required">
                        </td>
                    </tr>
 
                    <tr>
                        <td>
                            <input type="text" name="f_name" placeholder="Фамилия" required="required">
                        </td>
                    </tr>
              
                    <tr>
                        <td>
                            <input type="text" name="login" placeholder="Имя пользователя" required="required">
                        </td>
                    </tr>
